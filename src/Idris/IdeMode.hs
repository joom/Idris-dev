...
sexpToCommand (SexpList [SymbolAtom "elab-edit", StringAtom name, SexpList args, IntegerAtom line, IntegerAtom col]) =
    Just (ElabEdit name args (fromInteger line, fromInteger col))
