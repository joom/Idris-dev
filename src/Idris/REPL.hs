...
runIdeModeCommand h id orig fn mods (IdeMode.ElabEdit name args pos) =
  process fn (ElabEditAt name args pos)
...
process fn (ElabEditAt actionName sexps (l, c))
    = elabEditAt fn actionName (l, c) sexps
